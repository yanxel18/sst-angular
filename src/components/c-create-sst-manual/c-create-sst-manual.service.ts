...
import {
  ...
  HandleError,
} from 'src/error-handler/http-error-handler.service';
const httpOptions = {
...
export class CCreateSstManualService {
  ...
  getBaseList(): Observable<SSTModel.IBase[]> {
    ...
    return this.http
      .get<SSTModel.IBase[]>(url)
      .pipe(catchError(this.handleError('getBaseList', [])));
  }
  /**
   *
  ...
  getMachineList(): Observable<SSTModel.MachineList[]> {
    ...
    return this.http
      .get<SSTModel.MachineList[]>(url)
      .pipe(catchError(this.handleError('getMachineList', [])));
  }
  /**
   *
   * @returns 工程list
  ...
  getProcessList(): Observable<SSTModel.ProcessList[]> {
    ...
    return this.http
      .get<SSTModel.ProcessList[]>(url)
      .pipe(catchError(this.handleError('getProcessList', [])));
  }
  /**
   *
   * @returns Tools List
  ...
  getToolsListAction(): Observable<SSTModel.ToolsListAction[]> {
    ...
    return this.http
      .get<SSTModel.ToolsListAction[]>(url)
      .pipe(catchError(this.handleError('getToolsListAction', [])));
  }
  /**
   *
   * @returns 分析Tools
  ...
  getToolsListAnalysis(): Observable<SSTModel.ToolsListAnalysis[]> {
    ...
    return this.http
      .get<SSTModel.ToolsListAnalysis[]>(url)
      .pipe(catchError(this.handleError('getToolsListAnalysis', [])));
  }
  /**
   *
   * @returns 気づきTools
  ...
  getToolsListAwareness(): Observable<SSTModel.ToolsListAwareness[]> {
    ...
    return this.http
      .get<SSTModel.ToolsListAwareness[]>(url)
      .pipe(catchError(this.handleError('getToolsListAwareness', [])));
  }
  /**
   *
   * @returns 結果Tools
  ...
  getToolsListResult(): Observable<SSTModel.ToolsListResult[]> {
    ...
    return this.http
      .get<SSTModel.ToolsListResult[]>(url)
      .pipe(catchError(this.handleError('getToolsListResult', [])));
  }
  /**
   *
  ...
  getActivityList(): Observable<SSTModel.ActivityList[]> {
    ...
    return this.http
      .get<SSTModel.ActivityList[]>(url)
      .pipe(catchError(this.handleError('getActivityList', [])));
  }

  getActivityListonEdit(
    groupID: number | null | undefined
  ): Observable<SSTModel.ActivityList[]> {
    let queryParams = new HttpParams();
    if (groupID) queryParams = queryParams.append('stcID', groupID);
    const url = `${this.sstAPIURL}/sst/getActivityListonEdit`;
    return this.http
      .get<SSTModel.ActivityList[]>(url, { params: queryParams })
      .pipe(catchError(this.handleError('getActivityListonEdit', [])));
  }

  getActivityListGroup(): Observable<SSTModel.ActivityListGroup[]> {
    const url = `${this.sstAPIURL}/sst/getActivityListGroup`;
    return this.http
      .get<SSTModel.ActivityListGroup[]>(url)
      .pipe(catchError(this.handleError('getActivityListGroup', [])));
  }
}
